...
<div id="TagEditModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content" id="modal-content">
            ...
            <div class="modal-body" id="modal-body">
                <form id="TagEditModal-form" action="" method="post">
                    @method('PUT')
                    @csrf
                    <!-- Custom Tabs -->
                    <div class="card">
                        <input type="text" name="EditTagId" id="TagId">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane @if ($loop->first) active @endif" id="{{$value['locale']}}">
                                    <div class="mb-3">
                                        <textarea id="{{$value['locale']}}" name="{{$value['locale']}}" style="width: 100%"></textarea>
                                    </div>
                                </div>
                                @endforeach
                            </div>
