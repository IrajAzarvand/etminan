                        ...
                        <div class="card">
                            <div class="card-header d-flex p-0">
                                <ul class="nav nav-pills ml-auto p-2">
                                    <li class="nav-item"><a class="nav-link active" href="#Persian" data-toggle="tab">فارسی</a> </li>
                                    <li class="nav-item"><a class="nav-link" href="#English" data-toggle="tab">انگلیسی</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#Russian" data-toggle="tab">روسی</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#Arabic" data-toggle="tab">عربی</a></li>
                                </ul>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="Persian">
                                        <div class="mb-3">
                                            <textarea id="editor1" name="Persian_Slider_Description" style="width: 100%" placeholder="توضیح مختصر"></textarea>
                                        </div>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="English">
                                        <div class="mb-3">
                                            <textarea id="editor1" name="English_Slider_Description" style="width: 100%" placeholder="Short Description"></textarea>
                                        </div>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="Russian">
                                        <div class="mb-3">
                                            <textarea id="editor1" name="Russian_Slider_Description" style="width: 100%" placeholder="Краткое объяснение"></textarea>
                                        </div>
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="Arabic">
                                        <div class="mb-3">
                                            <textarea id="editor1" name="Arabic_Slider_Description" style="width: 100%" placeholder="شرح موجز"></textarea>
                                        </div>
                                    </div>
                                    <!-- /.tab-pane -->
                                </div>
