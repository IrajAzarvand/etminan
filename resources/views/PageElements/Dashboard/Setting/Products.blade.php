    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#Persian" data-toggle="tab">فارسی</a></li>
                <li><a href="#English" data-toggle="tab">انگلیسی</a></li>
                <li><a href="#Russian" data-toggle="tab">روسی</a></li>
                <li><a href="#Arabic" data-toggle="tab">عربی</a></li>
            </ul>
            <div class="tab-content">

                {{-- Persian --}}
                <div class="active tab-pane" id="Persian">
                    @include('PageElements.Dashboard.Shared.TinyMCE')
                </div>
