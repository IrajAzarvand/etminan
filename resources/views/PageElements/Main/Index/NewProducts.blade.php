...
<section class="portfolio_teasers_wrapper">
    ...
    <div class="container">
        <h2 class="section_header fancy centered">پروژه های اخیری که اجرا کرده ایم</h2>
        ...
        <div class="centered_button"><a class="btn btn-primary" href="portfolio.html">بیشتر</a></div>
    </div>
</section>
